...
export const metadata = {
  ...
  description: 'Nervous system regulation and overthinking.',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl font-light text-gray-600 mb-8">
              Regulate your nervous system and overcome overthinking.
            </p>
            <a
              href="https://calendly.com/tinamujera/30min?utm_source=coachtina&utm_medium=website&utm_campaign=discovery_call&utm_content=trans_hub_anxiety"
              target="_blank"
