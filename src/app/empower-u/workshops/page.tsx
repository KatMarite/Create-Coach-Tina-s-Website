...
export const metadata = {
  title: 'Empower U Workshops | Coach Tina',
  description: 'Workshops for schools and holiday programs.',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl font-light text-gray-600 mb-8">
              Engaging school programs, holiday camps, and parent-child workshops.
            </p>
            <a
              href="https://calendly.com/tinamujera/30min?utm_source=coachtina&utm_medium=website&utm_campaign=discovery_call&utm_content=empower_u_workshops"
              target="_blank"
